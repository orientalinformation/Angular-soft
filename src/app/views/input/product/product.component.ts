...
export class ProductComponent implements OnInit, AfterViewInit {
  ...
  updateProductElement() {
    ...
    if (!this.elementForm.specific_dim4) {
      this.toastr.error(this.translate.instant('Enter a value in Specific Dim 4. !'), 'Error');
      return;
    } else if (!this.isNumberic(this.elementForm.specific_dim4)) {
      this.toastr.error(this.translate.instant('Not a valid number in Specific Dim 4. !'), 'Error');
      return;
    } else if (!this.isInRangeOutput(this.elementForm.specific_dim4, this.minmaxProductMeshPacking.mmDim2.LIMIT_MIN,
      this.minmaxProductMeshPacking.mmDim2.LIMIT_MAX)) {
      this.toastr.error(this.translate.instant('Value out of range in Specific Dim 4.') +
        ' (' + this.minmaxProductMeshPacking.mmDim2.LIMIT_MIN + ' : ' + this.minmaxProductMeshPacking.mmDim2.LIMIT_MAX + ') !', 'Error');
      return;
    }

    if (!this.elementForm.specific_dim5) {
      this.toastr.error(this.translate.instant('Enter a value in Specific Dim 5. !'), 'Error');
      return;
    } else if (!this.isNumberic(this.elementForm.specific_dim5)) {
      this.toastr.error(this.translate.instant('Not a valid number in Specific Dim 5. !'), 'Error');
      return;
    } else if (!this.isInRangeOutput(this.elementForm.specific_dim5, this.minmaxProductMeshPacking.mmDim2.LIMIT_MIN,
      this.minmaxProductMeshPacking.mmDim2.LIMIT_MAX)) {
      this.toastr.error(this.translate.instant('Value out of range in Specific Dim 5.') +
        ' (' + this.minmaxProductMeshPacking.mmDim2.LIMIT_MIN + ' : ' + this.minmaxProductMeshPacking.mmDim2.LIMIT_MAX + ') !', 'Error');
      return;
    }
